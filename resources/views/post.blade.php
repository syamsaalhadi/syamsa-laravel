...
<main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white rounded-xl dark:bg-gray-900 antialiased">
    <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
        <article class="mx-auto w-full max-w-4xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                ...
                <address class="flex items-center mb-6 not-italic">
                    <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                        ...
                        <div>
                         ...
                         <a href="/categories/{{ $post->category->slug}}"> <p class="bg-{{ $post->category->color }}-100 text-primary-800 text-xs font-medium items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">{{ $post->category->name}}</p> </a>
            ...
            <a href="/posts" class="font-medium text-sm py-2 text-blue-500 hover:underline">&laquo; Back to all posts</a>
        </article>
        </div>
</main>
